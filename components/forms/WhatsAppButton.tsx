...
export function WhatsAppButton({ productName, className }: WhatsAppButtonProps) {
  ...
  return (
    <a
      ...
      className={`inline-flex items-center gap-[clamp(0.375rem,1vw,0.5rem)] rounded-[clamp(0.375rem,1vw,0.5rem)] bg-green-600 px-[clamp(1rem,3vw,1.5rem)] py-[clamp(0.5rem,1.2vw,0.75rem)] text-[clamp(0.875rem,1.4vw,1rem)] font-semibold text-white hover:bg-green-500 transition-colors ${className ?? ""}`}
    >
